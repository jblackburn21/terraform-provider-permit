module github.com/jblackburn21/terraform-provider-permit
...
replace github.com/permitio/permit-golang v0.0.5 => "/Users/jblackburn/repos/github/permit/permit-golang"
